  ...
  async insertDummyUsers(): Promise<{ message: string }> {
    try {
      ...
      const dummyUsers: UserEntity[] = [
        { loginName: 'dummy1', profileName: 'dummy1', profileImage: 'uploadsDummies/dummy_image.jpg', intraId: 1, hashedSecret: 'hashedSecret1', email: 'email@email.com', onlineStatus: false, rank: 7, gamesPlayed: 20, gamesWon: 11, gamesLost: 9, tfaEnabled: true, tfaCode: 'default', isFirstLogin: true, refreshToken: 'default', friendships: [], chatmessages: null, rooms_created: []},
        { loginName: 'dummy2', profileName: 'dummy2', profileImage: 'uploadsDummies/dummy_image.jpg', intraId: 2, hashedSecret: 'hashedSecret2', email: 'email@email.com', onlineStatus: false, rank: 3, gamesPlayed: 21, gamesWon: 13, gamesLost: 8, tfaEnabled: true, tfaCode: 'default', isFirstLogin: true, refreshToken: 'default', friendships: [], chatmessages: null, rooms_created: []},
        { loginName: 'dummy3', profileName: 'dummy3', profileImage: 'uploadsDummies/dummy_image.jpg', intraId: 3, hashedSecret: 'hashedSecret3', email: 'email@email.com', onlineStatus: false, rank: 9, gamesPlayed: 22, gamesWon: 15, gamesLost: 7, tfaEnabled: true, tfaCode: 'default', isFirstLogin: true, refreshToken: 'default', friendships: [], chatmessages: null, rooms_created: []},
        { loginName: 'dummy4', profileName: 'dummy4', profileImage: 'uploadsDummies/dummy_image.jpg', intraId: 4, hashedSecret: 'hashedSecret4', email: 'email@email.com', onlineStatus: false, rank: 8, gamesPlayed: 22, gamesWon: 17, gamesLost: 5, tfaEnabled: true, tfaCode: 'default', isFirstLogin: true, refreshToken: 'default', friendships: [], chatmessages: null, rooms_created: []},
        { loginName: 'dummy5', profileName: 'dummy5', profileImage: 'uploadsDummies/dummy_image.jpg', intraId: 5, hashedSecret: 'hashedSecret5', email: 'email@email.com', onlineStatus: false, rank: 2, gamesPlayed: 22, gamesWon: 19, gamesLost: 3, tfaEnabled: true, tfaCode: 'default', isFirstLogin: true, refreshToken: 'default', friendships: [], chatmessages: null, rooms_created: []},
      ];
