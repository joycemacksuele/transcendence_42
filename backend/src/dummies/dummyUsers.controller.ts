  ...
  async insertDummyUsers(): Promise<{ message: string }> {
    try {
      ...
      const dummyUsers: UserEntity[] = [
        { loginName: 'dummy1', profileName: 'dummy1', profileImage: 'uploadsDummies/dummy_image.jpg', intraId: 1, email: 'email@email.com', onlineStatus: false, rank: 0, gamesPlayed: 0, gamesWon: 0, gamesLost: 0, achievements: 'Lazy Lamb', tfaEnabled: true, tfaCode: 'default', isFirstLogin: true, refreshToken: 'default', tfaVerified: true, friendships: [], chatMessages: null, roomsCreated: [], canChat: [], blockedUsers: []},

        { loginName: 'dummy2', profileName: 'dummy2', profileImage: 'uploadsDummies/dummy_image.jpg', intraId: 2, email: 'email@email.com', onlineStatus: false, rank: 0, gamesPlayed: 0, gamesWon: 0, gamesLost: 0, achievements: 'Lazy Lamb', tfaEnabled: true, tfaCode: 'default', isFirstLogin: true, refreshToken: 'default', tfaVerified: true, friendships: [], chatMessages: null, roomsCreated: [], canChat: [], blockedUsers: []},

        { loginName: 'dummy3', profileName: 'dummy3', profileImage: 'uploadsDummies/dummy_image.jpg', intraId: 3, email: 'email@email.com', onlineStatus: false, rank: 0, gamesPlayed: 0, gamesWon: 0, gamesLost: 0, achievements: 'Lazy Lamb', tfaEnabled: true, tfaCode: 'default', isFirstLogin: true, refreshToken: 'default', tfaVerified: true, friendships: [], chatMessages: null, roomsCreated: [], canChat: [], blockedUsers: []},

        { loginName: 'dummy4', profileName: 'dummy4', profileImage: 'uploadsDummies/dummy_image.jpg', intraId: 4, email: 'email@email.com', onlineStatus: false, rank: 0, gamesPlayed: 0, gamesWon: 0, gamesLost: 0, achievements: 'Lazy Lamb', tfaEnabled: true, tfaCode: 'default', isFirstLogin: true, refreshToken: 'default', tfaVerified: true, friendships: [], chatMessages: null, roomsCreated: [], canChat: [], blockedUsers: []},
        
        { loginName: 'dummy5', profileName: 'dummy5', profileImage: 'uploadsDummies/dummy_image.jpg', intraId: 5, email: 'email@email.com', onlineStatus: false, rank: 0, gamesPlayed: 0, gamesWon: 0, gamesLost: 0, achievements: 'Lazy Lamb', tfaEnabled: true, tfaCode: 'default', isFirstLogin: true, refreshToken: 'default', tfaVerified: true, friendships: [], chatMessages: null, roomsCreated: [], canChat: [], blockedUsers: []},
