  ...
  async insertDummyUsers(): Promise<{ message: string }> {
    try {
      ...
      const dummyUsers: MyUser[] = [
        { id: 0, name: 'intra dummy 1', profileName: 'default name 1' },
        { id: 1, name: 'intra dummy 2', profileName: 'default name 2' },
        { id: 2, name: 'intra dummy 3', profileName: 'default name 3' },
        { id: 2, name: 'intra dummy 4', profileName: 'default name 4' },
        { id: 2, name: 'intra dummy 5', profileName: 'default name 5' },
